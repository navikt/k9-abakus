...
public class KafkaProperties {
    ...
    private static void putSecurity(Properties props) {
        boolean brukAivenPropetyLokalt = "true".equalsIgnoreCase(Environment.current().getProperty("KAFKA_BRUK_AIVEN_PROPERTY_LOKALT"));

        if (IS_DEPLOYMENT || brukAivenPropetyLokalt) {
            ...
            LOG.info("Bruker gammelt vtp oppsett.");
