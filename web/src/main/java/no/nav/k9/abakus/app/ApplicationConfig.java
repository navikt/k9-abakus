...
import no.nav.k9.abakus.app.exceptions.KnownExceptionMappers;
...
public class ApplicationConfig extends ResourceConfig {
    ...
    public ApplicationConfig() {
        ...
        Info info = new Info()
            .title("k9-oppdrag - saksbehandling av kapittel 9 i folketrygden")
            .version("1.0")
        ...
        SwaggerConfiguration oasConfig = new SwaggerConfiguration()
            ...
            .resourcePackages(Stream.of("no.nav.vedtak", "no.nav.k9")
