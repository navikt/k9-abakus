...
import no.nav.k9.abakus.web.jetty.db.DatabaseScript;
import no.nav.k9.abakus.web.jetty.db.DatasourceRole;
import no.nav.k9.abakus.web.jetty.db.DatasourceUtil;
...
public class JettyServer {
    ...
    protected WebAppContext createContext(AppKonfigurasjon appKonfigurasjon, Server server) throws IOException {
        ...
        Resource baseResource = createResourceCollection(server);
